        ...
        <div className="font-dm-sans bg-[#F7F8F5] pb-24">
            ...
            <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 text-center min-h-[60vh] flex flex-col items-center justify-center overflow-hidden bg-[#0B100B] border-b border-white/5">
                ...
                <div className="relative z-10 max-w-5xl mx-auto">
                    <h1 className="text-5xl md:text-7xl font-syne font-bold text-white tracking-tight mb-8">
            ...
            <section id="vision" className="max-w-[85%] mx-auto px-4 sm:px-6 lg:px-8 py-20 pt-28">
                <h2 className="text-4xl md:text-5xl font-syne font-bold text-[#0B100B] mb-16 text-center tracking-tight">Nuestra Visión</h2>
                <div className="grid md:grid-cols-2 gap-8">

                    {/* Vision Card */}
                    <div className="bg-white shadow-[0_2px_16px_rgba(0,0,0,0.08)] rounded-[16px] p-10 md:p-14 transition-transform duration-300 hover:-translate-y-1">
            ...
            <section id="etica" className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
                <h2 className="text-4xl md:text-5xl font-syne font-bold text-[#0B100B] mb-16 tracking-tight">Ética de Software</h2>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-20 text-center">
                <h2 className="text-4xl font-syne font-bold text-[#111311] mb-12">Nuestra Historia</h2>
                <div className="max-w-4xl mx-auto rounded-[16px] overflow-hidden aspect-video relative bg-[#EDEEE9] mb-10 border border-black/5 shadow-[0_8px_32px_rgba(0,0,0,0.08)]">
                    <img src={imgTeam} alt="Equipo Base QuetzalDev" className="w-full h-full object-cover" />
                </div>
                <p className="text-lg text-[#4A4F4A] max-w-3xl mx-auto leading-relaxed">
            ...
            <section id="contacto" className="max-w-[85%] mx-auto px-4 py-24 text-center">
                <div className="bg-white shadow-[0_2px_16px_rgba(0,0,0,0.08)] border border-gray-100 rounded-[16px] p-12 md:p-20">
